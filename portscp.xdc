...
set_property IOSTANDARD LVCMOS33 [get_ports {led_o1_tri_io[*]}]
set_property SLEW SLOW [get_ports {led_o1_tri_io[*]}]
set_property DRIVE 8 [get_ports {led_o1_tri_io[*]}]
...
set_property PACKAGE_PIN K14 [get_ports {led_o1_tri_io[0]}]
set_property PACKAGE_PIN G14 [get_ports {led_o1_tri_io[1]}]
set_property PACKAGE_PIN J15 [get_ports {led_o1_tri_io[2]}]
set_property PACKAGE_PIN J14 [get_ports {led_o1_tri_io[3]}]
